  ...
  return (
    <footer
      style={{
        ...
        borderTop: "1px solid rgba(14, 107, 168, 0.25)",
    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-4 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 flex-wrap">
          {navLinks.map((link) => (
            <Link
              ...
              onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = "var(--color-reef)")}
        ...
        {/* Social icons + copyright — right-side */}
        <div className="flex items-center gap-4">
          ...
          <span
            className="text-xs pl-4 whitespace-nowrap"
            style={{
              color: "var(--text-muted)",
              borderLeft: "1px solid rgba(14,107,168,0.25)",
            }}
          >
            © {currentYear} Rotaract Portal
          </span>
        </div>
