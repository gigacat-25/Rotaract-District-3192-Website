  ...
  return (
    <main className="lg:ml-64 min-h-screen relative overflow-visible pb-24 ">
        ...
        <div className="flex flex-col md:flex-row items-end justify-center gap-8 md:gap-12 pt-12">
          ...
          <div className="order-2 md:order-1 flex flex-col items-center w-full md:w-auto">
            <div className="relative group mb-8">
              <div className="absolute -top-4 -right-4 w-10 h-10 shadow-lg rounded-xl flex items-center justify-center text-on-surface-variant font-bold border border-outline/5 transition-transform group-hover:scale-110 z-20">2</div>
            ...
            <div className="text-center space-y-2 mb-8">
              ...
              <span className="-container-high text-primary font-bold text-[10px] px-3 py-1 rounded-lg uppercase">{top2.points} PTS</span>
            </div>
            <div className="w-40 h-32 -container-low/50 backdrop-blur-md rounded-t-[2.5rem] border-t border-white/40 shadow-sm"></div>
          </div>
          ...
          <div className="order-1 md:order-2 flex flex-col items-center w-full md:w-auto">
            ...
            <div className="w-56 h-48 -container-lowest/80 backdrop-blur-xl rounded-t-[3rem] border-t border-white shadow-2xl relative z-0">
          ...
          <div className="order-3 flex flex-col items-center w-full md:w-auto">
            <div className="relative group mb-8">
              <div className="absolute -top-4 -left-4 w-10 h-10 shadow-lg rounded-xl flex items-center justify-center text-on-surface-variant font-bold border border-outline/5 transition-transform group-hover:scale-110 z-20">3</div>
            ...
            <div className="text-center space-y-2 mb-8">
              ...
              <span className="-container-high text-primary font-bold text-[10px] px-3 py-1 rounded-lg uppercase">{top3.points} PTS</span>
            </div>
            <div className="w-36 h-24 -container-low/50 backdrop-blur-md rounded-t-[2.2rem] border-t border-white/40 shadow-sm"></div>
          </div>
        </div>
      </section>
      ...
      <section className="px-8 md:px-12">
        <div className="max-w-5xl mx-auto -container-lowest/70 backdrop-blur-xl rounded-[2.5rem] border border-white/40 shadow-xl overflow-hidden">
          <div className="p-8 border-b border-outline/5 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-3 p-1.5 -container-low rounded-2xl border border-white/10">
              ...
              <div key={index} className="p-8 hover:bg-white transition-all flex items-center gap-8 group">
                ...
                <div className="hidden md:flex items-center gap-2">
                  {member.badges.slice(0, 2).map((badge: string, bIdx: number) => (
                    <span key={bIdx} className="-container-low text-primary-container font-bold text-[9px] px-3 py-1.5 rounded-lg border border-white/20 uppercase tracking-widest shadow-sm group-hover:bg-primary group-hover:text-white transition-all duration-300">
                      {badge}
                    </span>
                  ))}
                </div>
